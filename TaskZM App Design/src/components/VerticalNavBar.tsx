...
export default function VerticalNavBar({
  ...
  return (
    <div className="w-20 h-screen flex-shrink-0 bg-white border-r border-[#e3e3e3] flex flex-col py-6">
      {navGroups.map((group, groupIndex) => (
        <div key={group.title} className="flex flex-col items-center">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  transition-all duration-200 group relative mb-2
                  ${
                    isActive
          ...
          {groupIndex < navGroups.length - 1 && (
            <div className="w-8 h-px bg-[#e3e3e3] my-2" />
          )}
        </div>
      ))}
    </div>
